        ...
        if (shpFile != null && shpFile.getName().endsWith(".shp")) {
            try {
                ...
                if (dialog.isAccepted()) {
                    ...
                    // Calculate the P parameters based on other parameters for all rows
                //    modifierController.calculateParametersP(fileCounter, totalRows);
            ...
            OptionPane.showErrorDialog("Nem megfelelõ fájlformátum. "
